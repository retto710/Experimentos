            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><button onclick="location.href='Registro_Servicio.jsp'" class="botn" style="width: 230px;" id="irARegisterServ">Registro de Servicio</button></li>
...
<!--                                         <option value="" >Categoría</option> -->
                                ...
                                <select id="selectTipoDocumento" class="form-control"  style="background-color:  #fff"name="slTipoDocumento" required="required" >
<!--                                     <option value="" >Tipo de Documento</option> -->
                                ...
                                <input type="number" class="form-control" name="txtCodigoDocumento" id="txtCodigoDocumentoRS" required="required" placeholder="Numero del Documento" style="background: white" onchange="ValidateRegisterService()" min="0">
                                <div id="validateDni"></div>
                                <br>
                                <input type="text"  class="form-control" name="txtServicioOfrecer" id="txtServicioOfrecerRS" required="required" placeholder="Servicio a Ofrecer" style="background: white">

                                <textarea type="text"  name="txtDescripcionServicio" class="form-control" id="txtDescripcionServicioRS" required="required" placeholder="Descripcion del Servicio" style="background: white" rows="5" cols="31"></textarea>
                                <textarea type="text"  class="form-control"name="txtObservaciones" id="txtObservacionesRS" required="required" placeholder="Observaciones" style="background: white" rows="5" cols="31" ></textarea>
                                ...
                                <p class="error" style="color: red;font-family: cursive;"><%= request.getAttribute("Error").toString()%></p>
                                    <% }%>
                                       ...
                                       <input type="submit" id="btnRegisterServicio" class="botn" value="Registrar Servicio"  style="margin: 10px !important;" >
