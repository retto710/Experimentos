                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="home.jsp">Servicios</a></li>
                         ...
                         <li>
                            ...
                            <button onclick="location.href='Registro_Servicio.jsp'" class="botn" style="width: 230px;" id="irARegisterServ">Registro de Servicio</button>
                        ...
                        <li class="dropdown" id="menuBase">
                            <a class="dropdown-toggle" data-toggle="dropdown" id="name" role="button" aria-expanded="false" >
                            ...
                            <ul class="dropdown-menu" role="menu" >
                                <li>
                                    <a href="perfilUsuario.jsp" id="perfil" title="Perfil">Perfil</a>
                                </li>
                                <li>
                    ...
                    <form id="Formulario" method="post" action="ServiciosServlet" >
                        <table  <%--class="fixed-height fixed-width fixed-cell table-spacing" --%> align="center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-primary" name="busqueda" id="btnBuscar"><span class="glyphicon glyphicon-search"  ></span></button>
                                    <br>
                                </td>
                            </tr> 
                    ...
                    <div class="table-striped">
                        ...
                        <form action="MasBuscado" method="get">
                            <table <%--class="table table-striped"  --%>align="center"  > 
                                <thead>
                                    <tr >
                                        <td style="color: gray   "  colspan="2" align="center"><br><h2 id = "titleMasBuscado">Más Buscado<h2></td>
                                                    </tr>
                                                    </thead>
                                                    <tbody align="center">
