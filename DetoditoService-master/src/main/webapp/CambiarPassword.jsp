...
<html lang="en">
    ...
    <head>
        ...
        <script type="text/javascript">
			...
			id_epassNew.innerHTML="La longitud minima tiene que ser de 6 caracteres";
			...
			id_epassNew.innerHTML="La contrasena tiene que tener numeros y letras";
		else
			id_epassNew.innerHTML="";
		if(pasActual.value=="")
			id_epassActual.innerHTML="La longitud minima tiene que ser de 6 caracteres";
		else
       ...
       <nav class="navbar navbar-inverse navbar-fixed-top">
        ...
        <div class="container-fluid" >
            ...
            <div >
                    ...
                    <center>
                        <form name="formName" action="CambioPassword" method="post" onsubmit="return validate_password()">
                           
                            <div id="epasswordActual" style="color:gray;"></div>
                            <div>Contraseña Actual: <input type="password" placeholder="Contraseña Actual" id="txtPasword" name="passwordActual"style="background: white"/></div>
                            <div id="epasswordNew1" style="color:#f00;"></div>
                            <div>Nuevo Contraseña: <input type="password" placeholder="Nueva Contraseña"class="textbox" name="passwordNew1" id="txtPasword1" style="background: white"/></div>
                            <div>Repite Contraseña: <input type="password" placeholder="Nueva Contraseña" class="textbox"name="passwordNew2" id="txtPasword2" style="background: white"/></div>
                            <br>
                            <div><a href="perfilUsuario.jsp"><input type="button" value="volver" class="btn btn-primary">  </a>
                                <input type="submit" value="Actualizar" class="btn btn-primary" id="btnActualizar"/></div>
