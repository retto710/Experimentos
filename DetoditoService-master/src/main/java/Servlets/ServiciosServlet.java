...
public class ServiciosServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String option = request.getParameter("slCategorias");
        int servicioId = Integer.valueOf(option);
        String busqueda = request.getParameter("buscar");
        
        IServiciosRep serviciosRep = new ServiciosRep();
        List<Servicios> servicios = serviciosRep.GetAllServicios(busqueda, servicioId);
