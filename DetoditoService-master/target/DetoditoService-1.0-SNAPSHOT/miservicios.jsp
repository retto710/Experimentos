<%-- 
    Document   : miservicios
    Created on : 15/04/2018, 01:18:28 AM
    Author     : CASA
--%>
      ...
      <div class="container-fluid" >
            ...
            <div class="row"> 
                ...
                <div class="col-sm-9 col-sm-offset- col-md-10 col-md-offset-1 main">
                    ...
                    <div id="formRegistro">
                        <div id="confirm">              
                         <h1 style="color: gray;text-align: center">Mis Servicios</h1>
                         <center>
                                ...
                                <%Usuarios actual= (Usuarios)session.getAttribute("CurrentUser");
                                   ...
                                   List <Servicios> listita=repo.GetServiciosByProveedorId(actual.getId());
                               %>
                                <table class="table table-striped table-hover table-bordered ">
                                    ...
                                    <th>Distrito</th>
                                    <th>Estado</th>
                                    <%for(Servicios p:listita){%>     

                                    <tr class="info">
                                        <td><%=p.getNombre()%></td>
                                        <td><%=p.getDescripcion()%></td>
                                        <td><%=p.getObservaciones()%></td>
                                        <td><%=p.getDistritos().getNombre()%></td>
                                        <td><%=p.getEstado()%></td>
                                    </tr>                
                                    <%}%>
                                </table>
